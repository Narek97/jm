...
// } from "@/api/queries/generated/getUserLastPerformanceLog.generated";
//
...
//     useGetUserLastPerformanceLogQuery<GetUserLastPerformanceLogQuery, Error>();
//
...
//
//       <div
//         className={"last-user-query-modal"}
//         data-testid="last-user-query-modal-test-id"
//       >
//         {isLoadingQuery ? (
//           <CustomLoader />
//         ) : (
...
//                 className={
//                   "last-user-query-modal--key last-user-query-modal--time-key"
//                 }
//                 style={{
...
//               <p
//                 className={
//                   "last-user-query-modal--key last-user-query-modal--size-key"
//                 }
//                 data-testid="query-payload-size-test-id"
//                 style={{
//                   background: getResponsePayloadSizeColor(
//                     query?.payloadSize || 0,
//                   ),
//                 }}
//               >
...
//                 {query?.sqlRowQueries?.map((el: string, index: number) => (
//                   <li key={index}>
//                     <span>{index + 1}: </span>
//                     <span>{el}</span>
//                   </li>
