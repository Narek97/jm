...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetMapPersonasForOutcomeQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetMapPersonasForOutcomeQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetMapPersonasForOutcomeQuery,
      GetMapPersonasForOutcomeQueryVariables
    >(GetMapPersonasForOutcomeDocument).bind(null, variables),
    ...options,
  });
};

useGetMapPersonasForOutcomeQuery.getKey = (
  variables: GetMapPersonasForOutcomeQueryVariables,
) => ["GetMapPersonasForOutcome", variables];
    ...
    (() => {
      ...
      return {
        queryKey: optionsQueryKey ?? [
          "GetMapPersonasForOutcome.infinite",
          variables,
        ],
        queryFn: (metaData) =>
