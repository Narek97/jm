...
export const useGetMapsQuery = <TData = GetMapsQuery, TError = unknown>(
  ...
  return useQuery<GetMapsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<GetMapsQuery, GetMapsQueryVariables>(GetMapsDocument).bind(
      null,
      variables,
    ),
    ...options,
...
export const useInfiniteGetMapsQuery = <TData = InfiniteData<GetMapsQuery>, TError = unknown>(
  variables: GetMapsQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetMapsQuery, TError, TData>, 'queryKey'> & {
