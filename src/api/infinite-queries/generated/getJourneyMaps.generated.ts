...
export const useGetMapsQuery = <
      TData = GetMapsQuery,
      TError = unknown
    >(
      variables: GetMapsQueryVariables,
      options?: Omit<UseQueryOptions<GetMapsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetMapsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetMapsQuery, TError, TData>(
      {
    queryKey: ['GetMaps', variables],
    queryFn: axiosRequest<GetMapsQuery, GetMapsQueryVariables>(GetMapsDocument).bind(null, variables),
    ...options
  }
    )};

useGetMapsQuery.getKey = (variables: GetMapsQueryVariables) => ['GetMaps', variables];
...
export const useInfiniteGetMapsQuery = <
    ...
    >(
      variables: GetMapsQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetMapsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetMapsQuery, TError, TData>['queryKey'] }
    ) => {
    const query = axiosRequest<GetMapsQuery, GetMapsQueryVariables>(GetMapsDocument)
...
useInfiniteGetMapsQuery.getKey = (variables: GetMapsQueryVariables) => ['GetMaps.infinite', variables];
