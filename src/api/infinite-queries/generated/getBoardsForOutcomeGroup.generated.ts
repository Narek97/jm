...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetBoardsForOutcomeGroupQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetBoardsForOutcomeGroupQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetBoardsForOutcomeGroupQuery,
      GetBoardsForOutcomeGroupQueryVariables
    >(GetBoardsForOutcomeGroupDocument).bind(null, variables),
    ...options,
  });
};

useGetBoardsForOutcomeGroupQuery.getKey = (
  variables: GetBoardsForOutcomeGroupQueryVariables,
) => ["GetBoardsForOutcomeGroup", variables];
    ...
    (() => {
      ...
      return {
        queryKey: optionsQueryKey ?? [
          "GetBoardsForOutcomeGroup.infinite",
          variables,
        ],
        queryFn: (metaData) =>
