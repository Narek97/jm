...
export type GetBoardsForOutcomeGroupQuery = {
  __typename?: 'Query';
  getBoardsForOutcomeGroup: {
    __typename?: 'GetOutcomeBoardsModel';
    limit: number;
    offset: number;
    count?: number | null;
    boards: Array<{
      __typename?: 'GetBoardsOutcomeGroupModel';
      id: number;
      name: string;
      isPinned: boolean;
    }>;
...
>(
  ...
  options?: Omit<UseQueryOptions<GetBoardsForOutcomeGroupQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<GetBoardsForOutcomeGroupQuery, TError, TData>['queryKey'];
  },
) => {
  return useQuery<GetBoardsForOutcomeGroupQuery, TError, TData>({
    queryKey: ['GetBoardsForOutcomeGroup', variables],
    queryFn: axiosRequest<GetBoardsForOutcomeGroupQuery, GetBoardsForOutcomeGroupQueryVariables>(
      GetBoardsForOutcomeGroupDocument,
    ).bind(null, variables),
    ...options,
  });
};

useGetBoardsForOutcomeGroupQuery.getKey = (variables: GetBoardsForOutcomeGroupQueryVariables) => [
  'GetBoardsForOutcomeGroup',
  variables,
];
...
>(
  variables: GetBoardsForOutcomeGroupQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetBoardsForOutcomeGroupQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseInfiniteQueryOptions<GetBoardsForOutcomeGroupQuery, TError, TData>['queryKey'];
  },
) => {
  const query = axiosRequest<GetBoardsForOutcomeGroupQuery, GetBoardsForOutcomeGroupQueryVariables>(
    GetBoardsForOutcomeGroupDocument,
  );
...
useInfiniteGetBoardsForOutcomeGroupQuery.getKey = (
  variables: GetBoardsForOutcomeGroupQueryVariables,
) => ['GetBoardsForOutcomeGroup.infinite', variables];
