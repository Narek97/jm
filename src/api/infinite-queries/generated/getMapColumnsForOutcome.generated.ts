...
export type GetMapColumnsForOutcomeQuery = {
  ...
  getMapColumnsForOutcome: {
    ...
    count?: number | null;
    columns: Array<{
      __typename?: "MapColumnForOutcome";
      id: number;
      label?: string | null;
    }>;
  };
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetMapColumnsForOutcomeQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetMapColumnsForOutcomeQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetMapColumnsForOutcomeQuery,
      GetMapColumnsForOutcomeQueryVariables
    >(GetMapColumnsForOutcomeDocument).bind(null, variables),
    ...options,
  });
};

useGetMapColumnsForOutcomeQuery.getKey = (
  variables: GetMapColumnsForOutcomeQueryVariables,
) => ["GetMapColumnsForOutcome", variables];
    ...
    (() => {
      ...
      return {
        queryKey: optionsQueryKey ?? [
          "GetMapColumnsForOutcome.infinite",
          variables,
        ],
        queryFn: (metaData) =>
