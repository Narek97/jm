...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetLinkMapsByBoardQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetLinkMapsByBoardQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetLinkMapsByBoardQuery,
      GetLinkMapsByBoardQueryVariables
    >(GetLinkMapsByBoardDocument).bind(null, variables),
    ...options,
  });
};

useGetLinkMapsByBoardQuery.getKey = (
  variables: GetLinkMapsByBoardQueryVariables,
) => ["GetLinkMapsByBoard", variables];
...
>(
  variables: GetLinkMapsByBoardQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetLinkMapsByBoardQuery, TError, TData>,
    "queryKey"
  > & {
...
useInfiniteGetLinkMapsByBoardQuery.getKey = (
  variables: GetLinkMapsByBoardQueryVariables,
) => ["GetLinkMapsByBoard.infinite", variables];
