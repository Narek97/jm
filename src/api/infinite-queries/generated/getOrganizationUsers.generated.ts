...
>(
  variables: GetOrganizationUsersQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetOrganizationUsersQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetOrganizationUsersQuery, TError, TData>['queryKey'];
  },
) => {
  const query = axiosRequest<GetOrganizationUsersQuery, GetOrganizationUsersQueryVariables>(
    GetOrganizationUsersDocument,
  );
...
useInfiniteGetOrganizationUsersQuery.getKey = (variables: GetOrganizationUsersQueryVariables) => [
