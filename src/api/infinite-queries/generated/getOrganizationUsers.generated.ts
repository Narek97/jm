...
export type GetOrganizationUsersQuery = { __typename?: 'Query', getOrganizationUsers: { __typename?: 'GetQuestionProUsersModel', count: number, users: Array<{ __typename?: 'Member', userId: number, firstName: string, lastName: string, isShared?: boolean | null, emailAddress: string }> } };
...
export const useInfiniteGetOrganizationUsersQuery = <
    ...
    >(
      variables: GetOrganizationUsersQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetOrganizationUsersQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetOrganizationUsersQuery, TError, TData>['queryKey'] }
    ) => {
    const query = axiosRequest<GetOrganizationUsersQuery, GetOrganizationUsersQueryVariables>(GetOrganizationUsersDocument)
    return useInfiniteQuery<GetOrganizationUsersQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetOrganizationUsers.infinite', variables],
...
useInfiniteGetOrganizationUsersQuery.getKey = (variables: GetOrganizationUsersQueryVariables) => ['GetOrganizationUsers.infinite', variables];
