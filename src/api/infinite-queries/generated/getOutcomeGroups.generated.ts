...
>(
  variables: GetOutcomeGroupsQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetOutcomeGroupsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetOutcomeGroupsQuery, TError, TData>['queryKey'];
  },
) => {
  const query = axiosRequest<GetOutcomeGroupsQuery, GetOutcomeGroupsQueryVariables>(
    GetOutcomeGroupsDocument,
  );
...
useInfiniteGetOutcomeGroupsQuery.getKey = (variables: GetOutcomeGroupsQueryVariables) => [
  'GetOutcomeGroups.infinite',
  variables,
];
