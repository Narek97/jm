...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetJourneysForCopyQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetJourneysForCopyQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetJourneysForCopyQuery,
      GetJourneysForCopyQueryVariables
    >(GetJourneysForCopyDocument).bind(null, variables),
    ...options,
  });
};

useGetJourneysForCopyQuery.getKey = (
  variables: GetJourneysForCopyQueryVariables,
) => ["GetJourneysForCopy", variables];
...
>(
  variables: GetJourneysForCopyQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetJourneysForCopyQuery, TError, TData>,
    "queryKey"
  > & {
...
useInfiniteGetJourneysForCopyQuery.getKey = (
  variables: GetJourneysForCopyQueryVariables,
) => ["GetJourneysForCopy.infinite", variables];
