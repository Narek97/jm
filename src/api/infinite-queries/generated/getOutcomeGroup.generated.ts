...
export const useInfiniteGetOutcomeGroupQuery = <
    ...
    >(
      variables: GetOutcomeGroupQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetOutcomeGroupQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetOutcomeGroupQuery, TError, TData>['queryKey'] }
    ) => {
    const query = axiosRequest<GetOutcomeGroupQuery, GetOutcomeGroupQueryVariables>(GetOutcomeGroupDocument)
...
useInfiniteGetOutcomeGroupQuery.getKey = (variables: GetOutcomeGroupQueryVariables) => ['GetOutcomeGroup.infinite', variables];
