...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetPersonaGroupsWithPersonasQuery, TError, TData>,
    "queryKey"
  > & {
...
>(
  variables: GetPersonaGroupsWithPersonasQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetPersonaGroupsWithPersonasQuery, TError, TData>,
    "queryKey"
  > & {
...
useInfiniteGetPersonaGroupsWithPersonasQuery.getKey = (
  variables: GetPersonaGroupsWithPersonasQueryVariables,
) => ["GetPersonaGroupsWithPersonas.infinite", variables];
