...
export const useGetMapLogsQuery = <TData = GetMapLogsQuery, TError = unknown>(
  ...
  options?: Omit<UseQueryOptions<GetMapLogsQuery, TError, TData>, 'queryKey'> & {
  ...
  return useQuery<GetMapLogsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<GetMapLogsQuery, GetMapLogsQueryVariables>(GetMapLogsDocument).bind(
      null,
      variables,
    ),
    ...options,
...
export const useInfiniteGetMapLogsQuery = <TData = InfiniteData<GetMapLogsQuery>, TError = unknown>(
  variables: GetMapLogsQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetMapLogsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetMapLogsQuery, TError, TData>['queryKey'];
  },
) => {
