...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetWorkspaceMapsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetWorkspaceMapsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetWorkspaceMapsQuery,
      GetWorkspaceMapsQueryVariables
    >(GetWorkspaceMapsDocument).bind(null, variables),
    ...options,
  });
};

useGetWorkspaceMapsQuery.getKey = (
  variables: GetWorkspaceMapsQueryVariables,
) => ["GetWorkspaceMaps", variables];
...
>(
  variables: GetWorkspaceMapsQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetWorkspaceMapsQuery, TError, TData>,
    "queryKey"
  > & {
...
useInfiniteGetWorkspaceMapsQuery.getKey = (
  variables: GetWorkspaceMapsQueryVariables,
) => ["GetWorkspaceMaps.infinite", variables];
