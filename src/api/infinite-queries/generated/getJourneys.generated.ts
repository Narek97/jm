...
export type GetJourneysQuery = { __typename?: 'Query', getMaps: { __typename?: 'GetMapsModel', count?: number | null, maps: Array<{ __typename?: 'Map', title?: string | null, id: number, type: string, createdAt: any, updatedAt: any, owner: { __typename?: 'Member', firstName: string, lastName: string, emailAddress: string }, selectedPersonas: Array<{ __typename?: 'personas', type: string, name: string, color?: string | null, id: number, croppedArea?: { __typename?: 'Position', width?: number | null, height?: number | null, x?: number | null, y?: number | null } | null, attachment?: { __typename?: 'Attachment', url: string, key: string, croppedArea?: { __typename?: 'Position', width?: number | null, height?: number | null, x?: number | null, y?: number | null } | null } | null }>, parentMaps: Array<{ __typename?: 'ParentMap', parentMap: { __typename?: 'Map', title?: string | null } }>, childMaps: Array<{ __typename?: 'ParentMap', childId: number, id: number }> }> } };
...
export const useInfiniteGetJourneysQuery = <
    ...
    >(
      variables: GetJourneysQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetJourneysQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetJourneysQuery, TError, TData>['queryKey'] }
    ) => {
    const query = axiosRequest<GetJourneysQuery, GetJourneysQueryVariables>(GetJourneysDocument)
...
useInfiniteGetJourneysQuery.getKey = (variables: GetJourneysQueryVariables) => ['GetJourneys.infinite', variables];
