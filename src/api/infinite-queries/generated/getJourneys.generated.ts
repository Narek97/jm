...
export type GetJourneysQuery = {
  ...
  getMaps: {
    ...
    maps: Array<{
      ...
      childMaps: Array<{ __typename?: 'ParentMap'; childId: number; id: number }>;
    }>;
  };
};
...
export const useGetJourneysQuery = <TData = GetJourneysQuery, TError = unknown>(
  ...
  options?: Omit<UseQueryOptions<GetJourneysQuery, TError, TData>, 'queryKey'> & {
  ...
  return useQuery<GetJourneysQuery, TError, TData>({
    ...
    queryFn: axiosRequest<GetJourneysQuery, GetJourneysQueryVariables>(GetJourneysDocument).bind(
      null,
      variables,
    ),
    ...options,
...
>(
  variables: GetJourneysQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetJourneysQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetJourneysQuery, TError, TData>['queryKey'];
  },
) => {
