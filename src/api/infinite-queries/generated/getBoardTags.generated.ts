...
export const useInfiniteGetBoardTagsQuery = <
    ...
    >(
      variables: GetBoardTagsQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetBoardTagsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetBoardTagsQuery, TError, TData>['queryKey'] }
    ) => {
...
useInfiniteGetBoardTagsQuery.getKey = (variables: GetBoardTagsQueryVariables) => ['GetBoardTags.infinite', variables];
