...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetBoardTagsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetBoardTagsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<GetBoardTagsQuery, GetBoardTagsQueryVariables>(
      GetBoardTagsDocument,
    ).bind(null, variables),
    ...options,
  });
};
...
>(
  variables: GetBoardTagsQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetBoardTagsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  const query = axiosRequest<GetBoardTagsQuery, GetBoardTagsQueryVariables>(
    GetBoardTagsDocument,
  );
...
useInfiniteGetBoardTagsQuery.getKey = (
  variables: GetBoardTagsQueryVariables,
) => ["GetBoardTags.infinite", variables];
