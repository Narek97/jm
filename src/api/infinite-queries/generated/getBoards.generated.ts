...
export const useGetMyBoardsQuery = <TData = GetMyBoardsQuery, TError = unknown>(
  ...
  options?: Omit<
    UseQueryOptions<GetMyBoardsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetMyBoardsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<GetMyBoardsQuery, GetMyBoardsQueryVariables>(
      GetMyBoardsDocument,
    ).bind(null, variables),
    ...options,
  });
...
useGetMyBoardsQuery.getKey = (variables: GetMyBoardsQueryVariables) => [
  "getMyBoards",
  variables,
];
...
>(
  variables: GetMyBoardsQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetMyBoardsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  const query = axiosRequest<GetMyBoardsQuery, GetMyBoardsQueryVariables>(
    GetMyBoardsDocument,
  );
