...
export type GetMyBoardsQuery = {
  __typename?: 'Query';
  getMyBoards: {
    __typename?: 'GetUserBoardsModel';
    limit: number;
    offset: number;
    count?: number | null;
    workspace: { __typename?: 'Workspace'; id: number; name: string };
    boards: Array<{
      ...
      outcomeGroupWithOutcomeCounts: Array<{
...
export const useGetMyBoardsQuery = <TData = GetMyBoardsQuery, TError = unknown>(
  variables: GetMyBoardsQueryVariables,
  options?: Omit<UseQueryOptions<GetMyBoardsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<GetMyBoardsQuery, TError, TData>['queryKey'];
  },
) => {
  return useQuery<GetMyBoardsQuery, TError, TData>({
    queryKey: ['getMyBoards', variables],
    queryFn: axiosRequest<GetMyBoardsQuery, GetMyBoardsQueryVariables>(GetMyBoardsDocument).bind(
      null,
      variables,
    ),
    ...options,
...
>(
  variables: GetMyBoardsQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetMyBoardsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetMyBoardsQuery, TError, TData>['queryKey'];
  },
) => {
...
useInfiniteGetMyBoardsQuery.getKey = (variables: GetMyBoardsQueryVariables) => [
  'getMyBoards.infinite',
  variables,
];
