...
export const useGetWhiteboardsQuery = <TData = GetWhiteboardsQuery, TError = unknown>(
  variables: GetWhiteboardsQueryVariables,
  options?: Omit<UseQueryOptions<GetWhiteboardsQuery, TError, TData>, 'queryKey'> & {
...
>(
  variables: GetWhiteboardsQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetWhiteboardsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetWhiteboardsQuery, TError, TData>['queryKey'];
  },
) => {
...
useInfiniteGetWhiteboardsQuery.getKey = (variables: GetWhiteboardsQueryVariables) => [
  'GetWhiteboards.infinite',
  variables,
];
