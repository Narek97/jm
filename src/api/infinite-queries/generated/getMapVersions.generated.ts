...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetMapVersionsQuery, TError, TData>,
    "queryKey"
  > & {
...
>(
  variables: GetMapVersionsQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetMapVersionsQuery, TError, TData>,
    "queryKey"
  > & {
...
useInfiniteGetMapVersionsQuery.getKey = (
  variables: GetMapVersionsQueryVariables,
) => ["GetMapVersions.infinite", variables];
