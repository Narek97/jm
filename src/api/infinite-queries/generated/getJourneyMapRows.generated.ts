...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetJourneyMapRowsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetJourneyMapRowsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetJourneyMapRowsQuery,
      GetJourneyMapRowsQueryVariables
    >(GetJourneyMapRowsDocument).bind(null, variables),
    ...options,
  });
};

useGetJourneyMapRowsQuery.getKey = (
  variables: GetJourneyMapRowsQueryVariables,
) => ["GetJourneyMapRows", variables];
...
>(
  variables: GetJourneyMapRowsQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetJourneyMapRowsQuery, TError, TData>,
    "queryKey"
  > & {
...
useInfiniteGetJourneyMapRowsQuery.getKey = (
  variables: GetJourneyMapRowsQueryVariables,
) => ["GetJourneyMapRows.infinite", variables];
