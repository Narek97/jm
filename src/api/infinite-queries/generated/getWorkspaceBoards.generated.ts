...
export type GetWorkspaceBoardsQuery = {
  ...
  getWorkspaceBoards: {
    ...
    count?: number | null;
    boards: Array<{
      __typename?: "WorkspaceBoardResponse";
      id: number;
      name: string;
    }>;
  };
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetWorkspaceBoardsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetWorkspaceBoardsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetWorkspaceBoardsQuery,
      GetWorkspaceBoardsQueryVariables
    >(GetWorkspaceBoardsDocument).bind(null, variables),
    ...options,
  });
};

useGetWorkspaceBoardsQuery.getKey = (
  variables: GetWorkspaceBoardsQueryVariables,
) => ["GetWorkspaceBoards", variables];
...
>(
  variables: GetWorkspaceBoardsQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetWorkspaceBoardsQuery, TError, TData>,
    "queryKey"
  > & {
...
useInfiniteGetWorkspaceBoardsQuery.getKey = (
  variables: GetWorkspaceBoardsQueryVariables,
) => ["GetWorkspaceBoards.infinite", variables];
