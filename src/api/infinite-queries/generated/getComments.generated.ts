...
export const useGetItemCommentsQuery = <TData = GetItemCommentsQuery, TError = unknown>(
  variables: GetItemCommentsQueryVariables,
  options?: Omit<UseQueryOptions<GetItemCommentsQuery, TError, TData>, 'queryKey'> & {
...
>(
  variables: GetItemCommentsQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetItemCommentsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetItemCommentsQuery, TError, TData>['queryKey'];
  },
) => {
  const query = axiosRequest<GetItemCommentsQuery, GetItemCommentsQueryVariables>(
    GetItemCommentsDocument,
  );
...
useInfiniteGetItemCommentsQuery.getKey = (variables: GetItemCommentsQueryVariables) => [
  'GetItemComments.infinite',
  variables,
];
