...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetMapDebugLogsQuery, TError, TData>,
    "queryKey"
  > & {
...
>(
  variables: GetMapDebugLogsQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetMapDebugLogsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseInfiniteQueryOptions<
      GetMapDebugLogsQuery,
      TError,
      TData
    >["queryKey"];
  },
...
useInfiniteGetMapDebugLogsQuery.getKey = (
  variables: GetMapDebugLogsQueryVariables,
) => ["GetMapDebugLogs.infinite", variables];
