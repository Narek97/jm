...
>(
  variables: GetPerformanceLogsQueryVariables,
  options: Omit<UseInfiniteQueryOptions<GetPerformanceLogsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseInfiniteQueryOptions<GetPerformanceLogsQuery, TError, TData>['queryKey'];
  },
) => {
  const query = axiosRequest<GetPerformanceLogsQuery, GetPerformanceLogsQueryVariables>(
    GetPerformanceLogsDocument,
  );
...
useInfiniteGetPerformanceLogsQuery.getKey = (variables: GetPerformanceLogsQueryVariables) => [
  'GetPerformanceLogs.infinite',
  variables,
];
