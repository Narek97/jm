...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetWhiteboardDataItemsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetWhiteboardDataItemsQuery,
      TError,
      TData
    >["queryKey"];
  },
  ...
  return useQuery<GetWhiteboardDataItemsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetWhiteboardDataItemsQuery,
      GetWhiteboardDataItemsQueryVariables
    >(GetWhiteboardDataItemsDocument).bind(null, variables),
    ...options,
  });
};

useGetWhiteboardDataItemsQuery.getKey = (
  variables: GetWhiteboardDataItemsQueryVariables,
) => ["GetWhiteboardDataItems", variables];
