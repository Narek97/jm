...
export type BoardDataItemFragment = {
  ...
  selectedUser?: {
    ...
    isSelected: boolean;
    user: { __typename?: 'Member'; userId: number; emailAddress: string };
  } | null;
};
...
export type GetWhiteboardDataItemsQuery = {
  __typename?: 'Query';
  getWhiteboardDataItems: {
    __typename?: 'GetWhiteboardDataItemsModel';
    RECT: Array<{
      __typename?: 'WhiteboardDataItem';
      id: number;
      zIndex?: number | null;
...
>(
  ...
  options?: Omit<UseQueryOptions<GetWhiteboardDataItemsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<GetWhiteboardDataItemsQuery, TError, TData>['queryKey'];
  },
) => {
  return useQuery<GetWhiteboardDataItemsQuery, TError, TData>({
    queryKey: ['GetWhiteboardDataItems', variables],
    queryFn: axiosRequest<GetWhiteboardDataItemsQuery, GetWhiteboardDataItemsQueryVariables>(
      GetWhiteboardDataItemsDocument,
    ).bind(null, variables),
    ...options,
  });
};

useGetWhiteboardDataItemsQuery.getKey = (variables: GetWhiteboardDataItemsQueryVariables) => [
  'GetWhiteboardDataItems',
  variables,
];
