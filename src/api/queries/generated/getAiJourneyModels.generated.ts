...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAiJourneyModelsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetAiJourneyModelsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetAiJourneyModelsQuery,
      GetAiJourneyModelsQueryVariables
    >(GetAiJourneyModelsDocument).bind(null, variables),
    ...options,
  });
};

useGetAiJourneyModelsQuery.getKey = (
  variables: GetAiJourneyModelsQueryVariables,
) => ["GetAiJourneyModels", variables];
