...
export const useGetMapByVersionIdQuery = <
      TData = GetMapByVersionIdQuery,
      TError = unknown
    >(
      variables: GetMapByVersionIdQueryVariables,
      options?: Omit<UseQueryOptions<GetMapByVersionIdQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetMapByVersionIdQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetMapByVersionIdQuery, TError, TData>(
      {
    queryKey: ['GetMapByVersionId', variables],
    queryFn: axiosRequest<GetMapByVersionIdQuery, GetMapByVersionIdQueryVariables>(GetMapByVersionIdDocument).bind(null, variables),
    ...options
  }
    )};

useGetMapByVersionIdQuery.getKey = (variables: GetMapByVersionIdQueryVariables) => ['GetMapByVersionId', variables];
