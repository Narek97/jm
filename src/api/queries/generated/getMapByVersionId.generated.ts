...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetMapByVersionIdQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetMapByVersionIdQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetMapByVersionIdQuery,
      GetMapByVersionIdQueryVariables
    >(GetMapByVersionIdDocument).bind(null, variables),
    ...options,
  });
};

useGetMapByVersionIdQuery.getKey = (
  variables: GetMapByVersionIdQueryVariables,
) => ["GetMapByVersionId", variables];
