...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetParentMapChildrenQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetParentMapChildrenQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetParentMapChildrenQuery,
      GetParentMapChildrenQueryVariables
    >(GetParentMapChildrenDocument).bind(null, variables),
    ...options,
  });
};

useGetParentMapChildrenQuery.getKey = (
  variables: GetParentMapChildrenQueryVariables,
) => ["GetParentMapChildren", variables];
