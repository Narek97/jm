...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetWorkspaceByIdForAtlasQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetWorkspaceByIdForAtlasQuery,
      TError,
      TData
    >["queryKey"];
  },
  ...
  return useQuery<GetWorkspaceByIdForAtlasQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetWorkspaceByIdForAtlasQuery,
      GetWorkspaceByIdForAtlasQueryVariables
    >(GetWorkspaceByIdForAtlasDocument).bind(null, variables),
    ...options,
  });
};

useGetWorkspaceByIdForAtlasQuery.getKey = (
  variables: GetWorkspaceByIdForAtlasQueryVariables,
) => ["GetWorkspaceByIdForAtlas", variables];
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetWorkspaceByIdQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
  ...
  return useQuery<GetWorkspaceByIdQuery, TError, TData>({
    ...
    >(GetWorkspaceByIdDocument).bind(null, variables),
    ...options,
  });
};

useGetWorkspaceByIdQuery.getKey = (
  variables: GetWorkspaceByIdQueryVariables,
) => ["GetWorkspaceById", variables];
