...
export const useGetPinnedPersonaItemsQuery = <
      TData = GetPinnedPersonaItemsQuery,
      TError = unknown
    >(
      variables: GetPinnedPersonaItemsQueryVariables,
      options?: Omit<UseQueryOptions<GetPinnedPersonaItemsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetPinnedPersonaItemsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetPinnedPersonaItemsQuery, TError, TData>(
      {
    queryKey: ['GetPinnedPersonaItems', variables],
    queryFn: axiosRequest<GetPinnedPersonaItemsQuery, GetPinnedPersonaItemsQueryVariables>(GetPinnedPersonaItemsDocument).bind(null, variables),
    ...options
  }
    )};

useGetPinnedPersonaItemsQuery.getKey = (variables: GetPinnedPersonaItemsQueryVariables) => ['GetPinnedPersonaItems', variables];
