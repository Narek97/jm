...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetPinnedPersonaItemsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetPinnedPersonaItemsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetPinnedPersonaItemsQuery,
      GetPinnedPersonaItemsQueryVariables
    >(GetPinnedPersonaItemsDocument).bind(null, variables),
    ...options,
  });
};

useGetPinnedPersonaItemsQuery.getKey = (
  variables: GetPinnedPersonaItemsQueryVariables,
) => ["GetPinnedPersonaItems", variables];
