...
export const useGetBoardOutcomesStatQuery = <TData = GetBoardOutcomesStatQuery, TError = unknown>(
  variables: GetBoardOutcomesStatQueryVariables,
  options?: Omit<UseQueryOptions<GetBoardOutcomesStatQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<GetBoardOutcomesStatQuery, TError, TData>['queryKey'];
  },
) => {
  return useQuery<GetBoardOutcomesStatQuery, TError, TData>({
    queryKey: ['GetBoardOutcomesStat', variables],
    queryFn: axiosRequest<GetBoardOutcomesStatQuery, GetBoardOutcomesStatQueryVariables>(
      GetBoardOutcomesStatDocument,
    ).bind(null, variables),
    ...options,
  });
};

useGetBoardOutcomesStatQuery.getKey = (variables: GetBoardOutcomesStatQueryVariables) => [
  'GetBoardOutcomesStat',
  variables,
];
