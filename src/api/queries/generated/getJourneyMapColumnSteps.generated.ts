...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetJourneyMapColumnStepsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetJourneyMapColumnStepsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetJourneyMapColumnStepsQuery,
      GetJourneyMapColumnStepsQueryVariables
    >(GetJourneyMapColumnStepsDocument).bind(null, variables),
    ...options,
  });
};

useGetJourneyMapColumnStepsQuery.getKey = (
  variables: GetJourneyMapColumnStepsQueryVariables,
) => ["GetJourneyMapColumnSteps", variables];
