...
export type GetUserLastPerformanceLogQueryVariables = Types.Exact<{
  [key: string]: never;
}>;
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetUserLastPerformanceLogQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetUserLastPerformanceLogQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetUserLastPerformanceLogQuery,
      GetUserLastPerformanceLogQueryVariables
    >(GetUserLastPerformanceLogDocument).bind(null, variables),
    ...options,
  });
};

useGetUserLastPerformanceLogQuery.getKey = (
  variables?: GetUserLastPerformanceLogQueryVariables,
) =>
  variables === undefined
    ? ["GetUserLastPerformanceLog"]
