...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetBoardsForItemQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetBoardsForItemQuery,
      TError,
      TData
    >["queryKey"];
  },
  ...
  return useQuery<GetBoardsForItemQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetBoardsForItemQuery,
      GetBoardsForItemQueryVariables
    >(GetBoardsForItemDocument).bind(null, variables),
    ...options,
  });
};

useGetBoardsForItemQuery.getKey = (
  variables: GetBoardsForItemQueryVariables,
) => ["GetBoardsForItem", variables];
