...
export type GetWorkspacesByOrganizationIdQuery = {
  __typename?: 'Query';
  getWorkspacesByOrganizationId: {
    __typename?: 'GetUserWorkspacesModel';
    limit: number;
    offset: number;
    count?: number | null;
    workspaces: Array<{
...
>(
  ...
  options?: Omit<UseQueryOptions<GetWorkspacesByOrganizationIdQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<GetWorkspacesByOrganizationIdQuery, TError, TData>['queryKey'];
  },
) => {
  return useQuery<GetWorkspacesByOrganizationIdQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      ...
      GetWorkspacesByOrganizationIdQueryVariables
    >(GetWorkspacesByOrganizationIdDocument).bind(null, variables),
    ...options,
  });
};

useGetWorkspacesByOrganizationIdQuery.getKey = (
  variables: GetWorkspacesByOrganizationIdQueryVariables,
) => ['GetWorkspacesByOrganizationId', variables];
