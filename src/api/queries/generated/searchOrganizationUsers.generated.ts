...
>(
  ...
  options?: Omit<
    UseQueryOptions<SearchOrganizationUsersQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<SearchOrganizationUsersQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      SearchOrganizationUsersQuery,
      SearchOrganizationUsersQueryVariables
    >(SearchOrganizationUsersDocument).bind(null, variables),
    ...options,
  });
};

useSearchOrganizationUsersQuery.getKey = (
  variables: SearchOrganizationUsersQueryVariables,
) => ["SearchOrganizationUsers", variables];
