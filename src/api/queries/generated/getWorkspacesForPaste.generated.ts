...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetWorkspacesForPastQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetWorkspacesForPastQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetWorkspacesForPastQuery,
      GetWorkspacesForPastQueryVariables
    >(GetWorkspacesForPastDocument).bind(null, variables),
    ...options,
  });
};

useGetWorkspacesForPastQuery.getKey = (
  variables: GetWorkspacesForPastQueryVariables,
) => ["GetWorkspacesForPast", variables];
