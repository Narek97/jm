...
export type GetBoardByIdQuery = { __typename?: 'Query', getBoardById: { __typename?: 'Board', id: number, name: string, description?: string | null, defaultMapId?: number | null, createdAt: any, pinnedOutcomeGroupCount: number, workspace: { __typename?: 'Workspace', id: number, feedbackId: number, name: string, journeyMapCount: number, personasCount: number } } };
