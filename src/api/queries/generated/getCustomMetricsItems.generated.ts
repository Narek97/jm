...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetCustomMetricsItemsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetCustomMetricsItemsQuery,
      TError,
      TData
    >["queryKey"];
  },
  ...
  return useQuery<GetCustomMetricsItemsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetCustomMetricsItemsQuery,
      GetCustomMetricsItemsQueryVariables
    >(GetCustomMetricsItemsDocument).bind(null, variables),
    ...options,
  });
};

useGetCustomMetricsItemsQuery.getKey = (
  variables: GetCustomMetricsItemsQueryVariables,
) => ["GetCustomMetricsItems", variables];
