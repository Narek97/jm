...
export const useGetItemNoteQuery = <TData = GetItemNoteQuery, TError = unknown>(
  ...
  options?: Omit<UseQueryOptions<GetItemNoteQuery, TError, TData>, 'queryKey'> & {
  ...
  return useQuery<GetItemNoteQuery, TError, TData>({
    ...
    queryFn: axiosRequest<GetItemNoteQuery, GetItemNoteQueryVariables>(GetItemNoteDocument).bind(
      null,
      variables,
    ),
    ...options,
