...
export const useGetFoldersQuery = <TData = GetFoldersQuery, TError = unknown>(
  variables: GetFoldersQueryVariables,
  options?: Omit<
    UseQueryOptions<GetFoldersQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetFoldersQuery, TError, TData>["queryKey"];
  },
) => {
  return useQuery<GetFoldersQuery, TError, TData>({
    queryKey: ["GetFolders", variables],
    queryFn: axiosRequest<GetFoldersQuery, GetFoldersQueryVariables>(
      GetFoldersDocument,
    ).bind(null, variables),
    ...options,
  });
...
useGetFoldersQuery.getKey = (variables: GetFoldersQueryVariables) => [
  "GetFolders",
  variables,
];
