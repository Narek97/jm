...
export const useGetFoldersQuery = <TData = GetFoldersQuery, TError = unknown>(
  ...
  options?: Omit<UseQueryOptions<GetFoldersQuery, TError, TData>, 'queryKey'> & {
  ...
  return useQuery<GetFoldersQuery, TError, TData>({
    ...
    queryFn: axiosRequest<GetFoldersQuery, GetFoldersQueryVariables>(GetFoldersDocument).bind(
      null,
      variables,
    ),
    ...options,
