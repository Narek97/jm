...
>(
  ...
  options?: Omit<UseQueryOptions<GetMapSelectedPersonasQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<GetMapSelectedPersonasQuery, TError, TData>['queryKey'];
  },
) => {
  return useQuery<GetMapSelectedPersonasQuery, TError, TData>({
    queryKey: ['GetMapSelectedPersonas', variables],
    queryFn: axiosRequest<GetMapSelectedPersonasQuery, GetMapSelectedPersonasQueryVariables>(
      GetMapSelectedPersonasDocument,
    ).bind(null, variables),
    ...options,
  });
};

useGetMapSelectedPersonasQuery.getKey = (variables: GetMapSelectedPersonasQueryVariables) => [
  'GetMapSelectedPersonas',
  variables,
];
