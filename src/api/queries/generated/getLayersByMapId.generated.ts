...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetLayersByMapIdQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetLayersByMapIdQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetLayersByMapIdQuery,
      GetLayersByMapIdQueryVariables
    >(GetLayersByMapIdDocument).bind(null, variables),
    ...options,
  });
};

useGetLayersByMapIdQuery.getKey = (
  variables: GetLayersByMapIdQueryVariables,
) => ["GetLayersByMapId", variables];
