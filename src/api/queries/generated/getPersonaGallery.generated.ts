...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetPersonaGalleryQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetPersonaGalleryQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetPersonaGalleryQuery,
      GetPersonaGalleryQueryVariables
    >(GetPersonaGalleryDocument).bind(null, variables),
    ...options,
  });
};

useGetPersonaGalleryQuery.getKey = (
  variables: GetPersonaGalleryQueryVariables,
) => ["GetPersonaGallery", variables];
