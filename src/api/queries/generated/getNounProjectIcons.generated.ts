...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetNounProjectIconsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetNounProjectIconsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetNounProjectIconsQuery,
      GetNounProjectIconsQueryVariables
    >(GetNounProjectIconsDocument).bind(null, variables),
    ...options,
  });
};

useGetNounProjectIconsQuery.getKey = (
  variables: GetNounProjectIconsQueryVariables,
) => ["GetNounProjectIcons", variables];
