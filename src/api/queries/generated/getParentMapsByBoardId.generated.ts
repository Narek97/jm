...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetParentMapsByBoardIdQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetParentMapsByBoardIdQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetParentMapsByBoardIdQuery,
      GetParentMapsByBoardIdQueryVariables
    >(GetParentMapsByBoardIdDocument).bind(null, variables),
    ...options,
  });
};

useGetParentMapsByBoardIdQuery.getKey = (
  variables: GetParentMapsByBoardIdQueryVariables,
) => ["GetParentMapsByBoardId", variables];
