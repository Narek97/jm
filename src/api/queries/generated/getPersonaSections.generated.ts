...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetPersonaSectionsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetPersonaSectionsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetPersonaSectionsQuery,
      GetPersonaSectionsQueryVariables
    >(GetPersonaSectionsDocument).bind(null, variables),
    ...options,
  });
};

useGetPersonaSectionsQuery.getKey = (
  variables: GetPersonaSectionsQueryVariables,
) => ["GetPersonaSections", variables];
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetPinPersonaSectionsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetPinPersonaSectionsQuery,
      TError,
      TData
    >["queryKey"];
  },
  ...
  return useQuery<GetPinPersonaSectionsQuery, TError, TData>({
    ...
    queryFn: axiosRequest<
      GetPinPersonaSectionsQuery,
      GetPinPersonaSectionsQueryVariables
    >(GetPinPersonaSectionsDocument).bind(null, variables),
    ...options,
  });
};

useGetPinPersonaSectionsQuery.getKey = (
  variables: GetPinPersonaSectionsQueryVariables,
) => ["GetPinPersonaSections", variables];
