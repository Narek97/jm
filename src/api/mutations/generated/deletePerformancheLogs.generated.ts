...
export const useDeletePerformanceMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: axiosRequest<DeletePerformanceMutation, DeletePerformanceMutationVariables>(
