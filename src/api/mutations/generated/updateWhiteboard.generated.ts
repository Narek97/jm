...
export const useUpdateWhiteboardMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<UpdateWhiteboardMutation, TError, UpdateWhiteboardMutationVariables, TContext>) => {
    
    return useMutation<UpdateWhiteboardMutation, TError, UpdateWhiteboardMutationVariables, TContext>(
      {
    mutationKey: ['UpdateWhiteboard'],
    mutationFn: axiosRequest<UpdateWhiteboardMutation, UpdateWhiteboardMutationVariables>(UpdateWhiteboardDocument),
    ...options
  }
    )};
