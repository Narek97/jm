...
export const useUpdateWhiteboardMutation = <TError = unknown, TContext = unknown>(
  ...
  return useMutation<UpdateWhiteboardMutation, TError, UpdateWhiteboardMutationVariables, TContext>(
    {
      ...
      mutationFn: axiosRequest<UpdateWhiteboardMutation, UpdateWhiteboardMutationVariables>(
