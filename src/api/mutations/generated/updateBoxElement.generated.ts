...
export const useUpdateBoxElementMutation = <TError = unknown, TContext = unknown>(
  ...
  return useMutation<UpdateBoxElementMutation, TError, UpdateBoxElementMutationVariables, TContext>(
    {
      ...
      mutationFn: axiosRequest<UpdateBoxElementMutation, UpdateBoxElementMutationVariables>(
