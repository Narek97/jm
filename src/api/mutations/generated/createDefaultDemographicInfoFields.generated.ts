...
export type CreateDefaultDemographicInfoFieldsMutation = {
  __typename?: 'Mutation';
  createDefaultDemographicInfoFields: Array<{
...
export const useCreateDefaultDemographicInfoFieldsMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    CreateDefaultDemographicInfoFieldsMutation,
    TError,
    CreateDefaultDemographicInfoFieldsMutationVariables,
    TContext
  >,
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: axiosRequest<
      CreateDefaultDemographicInfoFieldsMutation,
      CreateDefaultDemographicInfoFieldsMutationVariables
    >(CreateDefaultDemographicInfoFieldsDocument),
    ...options,
  });
};
