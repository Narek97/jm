...
export type CreateMapLinkMutation = {
  __typename?: 'Mutation';
  addLink: {
...
export const useCreateMapLinkMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    CreateMapLinkMutation,
    TError,
    CreateMapLinkMutationVariables,
    TContext
  >,
) => {
  return useMutation<CreateMapLinkMutation, TError, CreateMapLinkMutationVariables, TContext>({
    mutationKey: ['CreateMapLink'],
    mutationFn: axiosRequest<CreateMapLinkMutation, CreateMapLinkMutationVariables>(
      CreateMapLinkDocument,
    ),
    ...options,
  });
};
