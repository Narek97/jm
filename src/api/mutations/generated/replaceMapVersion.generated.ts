...
export const ReplaceMapVersionDocument = `
  ...
  replaceMapVersion(replaceMapVersionInput: $replaceMapVersionInput) {
    title
    personas {
      id
      name
...
export const useReplaceMapVersionMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: axiosRequest<ReplaceMapVersionMutation, ReplaceMapVersionMutationVariables>(
