...
export const useDeletePersonaGroupMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: axiosRequest<DeletePersonaGroupMutation, DeletePersonaGroupMutationVariables>(
