...
export const useUpdateAiJourneyModelMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<UpdateAiJourneyModelMutation, TError, UpdateAiJourneyModelMutationVariables, TContext>) => {
    
    return useMutation<UpdateAiJourneyModelMutation, TError, UpdateAiJourneyModelMutationVariables, TContext>(
      {
    mutationKey: ['UpdateAiJourneyModel'],
    mutationFn: axiosRequest<UpdateAiJourneyModelMutation, UpdateAiJourneyModelMutationVariables>(UpdateAiJourneyModelDocument),
    ...options
  }
    )};
