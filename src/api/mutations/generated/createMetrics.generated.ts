...
export const useCreateMetricsMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<CreateMetricsMutation, TError, CreateMetricsMutationVariables, TContext>) => {
    
    return useMutation<CreateMetricsMutation, TError, CreateMetricsMutationVariables, TContext>(
      {
    mutationKey: ['CreateMetrics'],
    mutationFn: axiosRequest<CreateMetricsMutation, CreateMetricsMutationVariables>(CreateMetricsDocument),
    ...options
  }
    )};
